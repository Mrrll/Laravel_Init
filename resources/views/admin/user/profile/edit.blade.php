...
@section('content')
    <main class="container-fluid main-dashboard">
        <h1>Profile</h1>
        <x-dom.form :route="route('profile.update', $profile)" method="patch">
            <div class="grid align-items-center" style="--bs-gap: 1rem;"">
                    ...
                    <div id="preview_avatar" class="d-flex justify-content-center">
                        <div class="avatar">
                             @if($profile->image->first())
                                <img height="140px" width="140px" src="{{asset($profile->image->first()->url)}}">
                            @else
                ...
                <div class="g-col-12 g-col-md-6">
                    <x-dom.input label="First Name" type="text" name="first_name" id="first_name"
                        placeholder="First Name" :value="old('first_name',$profile->first_name)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-6">
                    <x-dom.input label="Second Name" type="text" name="second_name" id="second_name"
                        placeholder="Second Name" :value="old('second_name', $profile->second_name)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-3">
                    <x-dom.input label="Identity" type="text" name="identify" id="identify" placeholder="00000000-X"
                        :value="old('identify', $profile->identify)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-3">
                    <x-dom.input label="Country" type="text" name="country" id="country" placeholder="Spain"
                        :value="old('country', $profile->country)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-3">
                    <x-dom.input label="City" type="text" name="city" id="city" placeholder="Barcelona"
                        :value="old('city', $profile->city)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-3">
                    <x-dom.input label="Municipality" type="text" name="municipality" id="municipality"
                        placeholder="Castelldefels" :value="old('municipality', $profile->municipality)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-12">
                    <x-dom.input label="Address" type="text" name="address" id="address"
                        placeholder="Carrer 14 Bis, 2, 08860" :value="old('address', $profile->address)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-6">
                    <x-dom.input label="First phone" type="text" name="first_phone" id="first_phone"
                        placeholder="699 999 666" :value="old('first_phone', $profile->first_phone)"></x-dom.input>
                </div>
                <div class="g-col-12 g-col-md-6">
                    <x-dom.input label="Second phone" type="text" name="second_phone" id="second_phone"
                        placeholder="93 999 66 66" :value="old('second_phone', $profile->second_phone)"></x-dom.input>
                </div>
